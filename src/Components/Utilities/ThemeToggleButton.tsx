...
const ThemeToggleButton: React.FC = () => {
  ...
  const [dark, setDark] = React.useState(systemDefaultTheme);
    ...
    return (
      <>
        <label htmlFor="toggleTheme" className="mx-auto w-5 h-9 flex p-1 cursor-pointer rounded-full overflow-hidden border-2 border-light-secondary dark:border-dark-secondary bg-white-accent dark:bg-dark-accent " onClick={() => setDark(!dark)}>
